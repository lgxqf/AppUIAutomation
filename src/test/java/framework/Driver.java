...
public final class Driver {
    ...
    protected static String getScreenShortName(){
        String screenshotName = ConfigUtil.getScreenshotDir() + Util.getDatetime() + ".png" ;

        return  screenshotName;
    }

    protected static String getScreenShortName(String ext){
        String screenshotName = ConfigUtil.getScreenshotDir() + Util.getDatetime() + "_" + ext + ".png" ;
...
//                }
    ...
    public static MobileElement findElementWithoutException(By by, int second){
        MobileElement elem = null;
        try {
            elem = Driver.findElement(by,second);
        }catch (Exception e){
            log.info("Elems " + by.toString() +" is not found.");
        }
